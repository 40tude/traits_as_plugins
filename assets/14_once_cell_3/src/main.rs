...
use demo_registry_1::sensors::PH_SENSOR_REGISTRY;
use demo_registry_1::sensors::TEMPERATURE_SENSOR_REGISTRY;
...
fn main() {
    ...
    let thermo_01 = TEMPERATURE_SENSOR_REGISTRY.make_sensor("Thermocouple_type_128").expect("Unknown sensor");
