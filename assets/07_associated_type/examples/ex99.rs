...
// Measurable now have an associated type `Unit`.
...
fn main() {
    let sensor1 = TempSensorC { temp: 25.0, id: "Zoubida".into() };
    let sensor2 = TempSensorF { temp: 25.0, id: "Roberta".into() }; // 77°F
